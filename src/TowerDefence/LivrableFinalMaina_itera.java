...
/**
 * le livrable final du jeu de maniere interactive
 */
public class LivrableFinalMaina_itera {

    /**
     * le constructeur par defaut de la classe
     */
    public LivrableFinalMaina_itera () {
    }
    ...
    public static void main(String[] args) {
       ...
       if (args.length!=3) {
        System.out.println(  "Veuillez entrer trois nombres :ligne , colonne et nombre de ballon");
        return;
        }
